                    ...
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                               <g:message code="sponsorGroup.id.label" default="Id" />:
                            </td>
                            
                            <td valign="top" class="value">${fieldValue(bean:sponsorGroupInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:sponsorGroupInstance, field:'name')}</td>
